...
4. GET `localhost:3000/api/v1/admin`

- this endpoint is used to get the admin by id from the database.

5. PATCH `localhost:3000/api/v1/admin/`
...
6. PATCH `localhost:3000/api/v1/admin/password`
...
8- PATCH `localhost:3000/api/v1/client/password`
...
```
9- PATCH `localhost:3000/api/v1/client/sendotp`
body:
```json
{
  "email": ""
...
10- PATCH `localhost:3000/api/v1/client/verifyotp`
body:
```json
{
  "otp": "",
...
5. PATCH `localhost:3000/api/v1/trainer/verify/:id`
...
9- GET
 `localhost:3000/api/v1/trainer/me`
...
11- PATCH
 `localhost:3000/api/v1/trainer/password`
...
```
12- PATCH
 `localhost:3000/api/v1/trainer/sendotp`
...
13- PATCH
 `localhost:3000/api/v1/trainer/verifyotp`
...
6. GET `localhost:3000/api/v1/post/myposts`
...
7- PATCH `localhost:3000/api/v1/post/admin/:id`
...
8- PATCH `localhost:3000/api/v1/post/trainer/:id`
...
9- GET `localhost:3000/api/v1/post/unapproved`
...
10- PATCH `localhost:3000/api/v1/post/approve/:id`
...
11- DELETE `localhost:3000/api/v1/post/delete/:id`
...
1. POST `localhost:3000/api/v1/feedback`
...
4- DELETE `localhost:3000/api/v1/feedback/:id`
